...
df_result = pandas.concat([df_T,df_p,df_h,df_m,df_w, df_eta, df_Q, df_PP, df_s ])
df_result.to_csv("result_NH3_H2O_base_model_test_V2.csv")
print(f"----T:----\n{df_T}\n ----p:----\n{df_p}\n ----h:----\n{df_h} \n ----m:----\n{df_m} \n ----w:----\n{df_w}")
...
df_result = pandas.concat([df_T,df_p,df_h,df_m,df_w, df_eta, df_Q, df_PP, df_s ])
#df_result.to_csv("result_NH3_H2O_doubleLift_model_test.csv")
print(f"----T:----\n{df_T}\n ----p:----\n{df_p}\n ----h:----\n{df_h} \n ----m:----\n{df_m} \n ----w:----\n{df_w}")
...
df_result = pandas.concat([df_T,df_p,df_h,df_m,df_w, df_eta, df_Q, df_PP, df_s ])
#df_result.to_csv("result_NH3_H2O_doubleEffect_model_test.csv")
print(f"----T:----\n{df_T}\n ----p:----\n{df_p}\n ----h:----\n{df_h} \n ----m:----\n{df_m} \n ----w:----\n{df_w}")
