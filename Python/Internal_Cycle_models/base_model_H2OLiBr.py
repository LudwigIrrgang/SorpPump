...
#     def __init__( numpy, LiBrSol, H2O,CP):
#         np = numpy
#         LiBrSol = LiBrSol
#         CoolProp = CP
#         H2O = H2O 
...
def base_model_H2OLiBr(T, p, h, m, eta, Q, HX, s):     
    ...
    s.sol_abs_in = LiBrSol.Calc_s_from_T_X_LiBrSol_Patek(T.sol_abs_in,x.LiBr_poor)/(x.LiBr_poor*M_LiBr + x.H2O_poor*M_H2O)   # not accurate since solution can be subcooled
